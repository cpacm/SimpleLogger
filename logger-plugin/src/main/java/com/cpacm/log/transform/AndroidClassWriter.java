 ...
 */
public class AndroidClassWriter extends ClassWriter {

    public static final String TAG = "AndroidClassWriter";

    private static final String OBJECT = "java/lang/Object";

    private ClassLoader urlClassLoader;

    public AndroidClassWriter(ClassLoader urlClassLoader, int flags) {
        super(flags);
